...
const Home = () => {
  const [currentUrl, setCurrentUrl] = useState('/');
  const { postData, data, landingPageCategories, 
    landingPageFOEB,content2,setContent2,
    featuredProducts,setFeaturedProducts,
    slides, setSlides,getHomeSliderImages,
    getLandingPageContent2,getFeaturedProducts,
    trendingNow,getTrendingProductsData,
    financingBanners,getFinanceBannerImagesFromApi
   } = useLPContentContext();
  // const [loading, setLoading] = useState(false);
  // const [content2, setContent2] = useState({});
  // const [featuredProducts, setFeaturedProducts] = useState([]);
